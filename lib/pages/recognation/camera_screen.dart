...
class _CameraScreenState extends State<CameraScreen> {
  ...
  Future<File> takePicture() async {
    ...
    // String directoryPath = '${root.path}/eDapenda_Camera';
                  ...
                  ? Stack(
                      children: [
                        ...
                        Positioned(
                                  ...
                                  Container(
                                    ...
                                    child: InkWell(
                                      onTap: () async {
                                        ...
                                        if (widget.embedding.isNotEmpty) {
                                          recognition2 =
                                          ...
                                          // List<double> hasil = Recognizer().recog(image, location)
                                          context
                                              .read<CurrentImageCubit>()
                                              .setXFile(XFile(result.path));
                                          Navigator.pop(context);
                                      ...
                                      child: Icon(
                                        ...
                                        color: Colors.white,
                                        size:
                                            getActualY(y: 80, context: context),
                                      ),
                                    ),
                                  ),
                                  Container(
                            ...
                            //       bottom: getActualY(y: 48, context: context)),
                            //   color: Colors.black,
                            //   child: Row(
                            //     mainAxisAlignment: MainAxisAlignment.center,
                            //     children: [
  ...
  Future<Recognition> doFaceDetection(File file) async {
    ...
    Recognition recog =
        recognizer.recognize(croppedFace, boundingBox, widget.embedding);
    print(recog.embeddings);
